import { Bell, Calendar, Clock, FilePlus, LayoutDashboard, PanelLeft, PieChart, Settings } from "lucide-react"
...
const Navigation = () => {
  return <nav aria-label="main navigation" className="w-full main-navigation">
    <ul className="pb-8 lg:py-8 px-6 w-full space-y-5">
      ...
      <li className="w-full"><LinkNavigation href="/dashboard/areas" active="exact" icon={<PieChart className="w-6 h-6" />} text={<span>Areas</span>} /></li>
